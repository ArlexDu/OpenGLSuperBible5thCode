...
const char *szCubeFaces[6] = { "Chapter07/MultiTexture/pos_x.tga", "Chapter07/MultiTexture/neg_x.tga", "Chapter07/MultiTexture/pos_y.tga", "Chapter07/MultiTexture/neg_y.tga", "Chapter07/MultiTexture/pos_z.tga", "Chapter07/MultiTexture/neg_z.tga" };
...
void SetupRC()
	...
	pBytes = gltReadTGABits("Chapter07/MultiTexture/tarnish.tga", &iWidth, &iHeight, &iComponents, &eFormat);
    ...
    reflectionShader = gltLoadShaderPairWithAttributes("Chapter07/MultiTexture/Reflection.vp", "Chapter07/MultiTexture/Reflection.fp", 3, 
    ...
    skyBoxShader = gltLoadShaderPairWithAttributes("Chapter07/MultiTexture/SkyBox.vp", "Chapter07/MultiTexture/SkyBox.fp", 2, 
                                                GLT_ATTRIBUTE_VERTEX, "vVertex",
                                                GLT_ATTRIBUTE_NORMAL, "vNormal");
	...
	//激活GL_TEXTURE1作为当前活动纹理单元，并绑定纹理材质
	glActiveTexture(GL_TEXTURE1);
	glBindTexture(GL_TEXTURE_2D, tarnishTexture);
	//激活GL_TEXTURE0作为当前活动纹理单元，并绑定纹理材质
