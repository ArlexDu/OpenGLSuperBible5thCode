...
const char *szCubeFaces[6] = { "Chapter07/CubeMapped/pos_x.tga", "Chapter07/CubeMapped/neg_x.tga", "Chapter07/CubeMapped/pos_y.tga", "Chapter07/CubeMapped/neg_y.tga", "Chapter07/CubeMapped/pos_z.tga", "Chapter07/CubeMapped/neg_z.tga" };
...
void SetupRC()
    ...
    // 载入立方体六个面的纹理，立方体贴图虽然可以作为单独的纹理对象看待，但是它是由组成6个面的6个正方形的2D图像组成的
    for(i = 0; i < 6; i++)
        {        
	...
	// 创建立方体，第二个参数是立方体的半径即每个方向到立方体的半径都是20
    gltMakeCube(cubeBatch, 20.0f);
    
    reflectionShader = gltLoadShaderPairWithAttributes("Chapter07/CubeMapped/Reflection.vp", "Chapter07/CubeMapped/Reflection.fp", 2, 
    ...
    skyBoxShader = gltLoadShaderPairWithAttributes("Chapter07/CubeMapped/SkyBox.vp", "Chapter07/CubeMapped/SkyBox.fp", 2, 
                                                GLT_ATTRIBUTE_VERTEX, "vVertex",
                                                GLT_ATTRIBUTE_NORMAL, "vNormal");
