...
// Phong和传统的ADS着色器相比，不在顶点之间进行颜色值插值，而是在顶点之间进行表面法线插值。
// 这样做的好处肯定是颜色不再有锯齿感，更加的光滑，但是缺点是开销增大
// 因为顶点着色器是逐顶点的计算量和顶点的数量成正比，而片元着色器是逐像素的，计算量就会大大增加
...
void SetupRC(void)
	...
	ADSLightShader = shaderManager.LoadShaderPairWithAttributes("Chapter06/ADSPhong/ADSPhong.vp", "Chapter06/ADSPhong/ADSPhong.fp", 2, GLT_ATTRIBUTE_VERTEX, "vVertex",
