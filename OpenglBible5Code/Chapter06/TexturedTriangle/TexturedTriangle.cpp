...
void SetupRC()
	...
	myTexturedIdentityShader = gltLoadShaderPairWithAttributes("Chapter06/TexturedTriangle/TexturedIdentity.vp", "Chapter06/TexturedTriangle/TexturedIdentity.fp", 2, 
		                            GLT_ATTRIBUTE_VERTEX, "vVertex", GLT_ATTRIBUTE_TEXTURE0, "vTexCoords");

	glGenTextures(1, &textureID);
	glBindTexture(GL_TEXTURE_2D, textureID);
	LoadTGATexture("Chapter06/TexturedTriangle/stone.tga", GL_LINEAR, GL_LINEAR, GL_CLAMP_TO_EDGE);
	}
