...
// 本程序是生成一个逐渐变量的四个红色单元的一维纹理，利用漫反射强度作为一位纹理坐标，从而得到卡通的着色效果
...
void SetupRC(void)
	...
	// 这里生成着色器的属性有顶点坐标和顶点法线，没有设置纹理坐标属性，这个一维纹理坐标是在顶点着色器里面的漫反射强度
	toonShader = gltLoadShaderPairWithAttributes("Chapter06/ToonShader/ToonShader.vp", "Chapter06/ToonShader/ToonShader.fp", 2, GLT_ATTRIBUTE_VERTEX, "vVertex",
